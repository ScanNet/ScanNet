...
opt_string = [[
    ...
    --train_data            (default "data/h5_shapenet_complete/train_data.txt")     txt file containing train h5 filenames
    --test_data             (default "data/h5_shapenet_complete/test_data.txt")      txt file containing test h5 filenames
