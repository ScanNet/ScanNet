function createActionButtons(device) {
  var div = $('<div></div>');
  div.append(createButton('Scans', '/scans/manage?deviceId=' + device.id, 'View scans'));
  return div;
}
    ...
    "columns": [
        ...
        { "data": "names",
          ...
          "render": function ( data, type, full, meta ) {
            return getHtml(createFilterLinks('/scans/manage', full, 'names', { queryField: 'deviceName' }));
          }
        },
        { "data": "scans.length",
          "defaultContent": "" },
