...
you can download scannet dataset from here: [scannet](http://kaldir.vc.in.tum.de/scannet_benchmark/)

or you can use the following command to download scannet dataset:

```python
python download_scannet_v2_dataset -o <dir name>
```
